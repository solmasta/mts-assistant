...
function Btn({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      boxShadow: red ? "0 4px 16px rgba(37,99,235,.3)" : "none",
      ...style
    }
  }, c);
}
...
function Onboarding({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      inset: 0,
      pointerEvents: "none",
      background: _darkMode ? "radial-gradient(circle at 18% 8%, rgba(37,99,235,.28), transparent 34%), radial-gradient(circle at 82% 92%, rgba(37,99,235,.16), transparent 36%)" : "radial-gradient(circle at 18% 8%, rgba(37,99,235,.12), transparent 34%), radial-gradient(circle at 82% 92%, rgba(37,99,235,.08), transparent 36%)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    style: {
      ...
      background: _darkMode ? "rgba(37,99,235,.18)" : "rgba(37,99,235,.1)",
    ...
    style: {
      ...
      borderRadius: 14,
      letterSpacing: ".02em",
      boxShadow: canStart ? "0 14px 26px rgba(37,99,235,.38), inset 0 1px 0 rgba(255,255,255,.2)" : "none"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
...
function Dashboard({
  ...
  return /*#__PURE__*/React.createElement("div", {style:{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}},
    ...
    /*#__PURE__*/React.createElement("div", {style:{
      ...
      /* Top row: FieldPro logo left, theme toggle + MTS badge right */
      /*#__PURE__*/React.createElement("div", {style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}},
        /*#__PURE__*/React.createElement("img", {src:FieldPro_FULL,alt:"FieldPro",style:{height:44,display:"block",imageRendering:"crisp-edges",mixBlendMode:_darkMode?"screen":"multiply"}}),
    ...
    /*#__PURE__*/React.createElement("div", {style:{flex:1,overflowY:"auto",overflowX:"hidden",padding:"16px 14px 24px"}},
      ...
      /*#__PURE__*/React.createElement("button", {
        ...
        style:{
          ...
          boxShadow:"0 8px 28px rgba(37,99,235,.45), inset 0 1px 0 rgba(255,255,255,.15)"
        }
      },
      ...
      /* Connected Workflow */
      /*#__PURE__*/React.createElement("div", {style:{
        background:_darkMode?"linear-gradient(135deg,rgba(37,99,235,.1),rgba(100,0,0,.15))":"rgba(37,99,235,.06)",
        border:`1px solid rgba(37,99,235,.2)`,
        borderRadius:14,padding:14,marginBottom:16,
        boxShadow:"inset 0 1px 0 rgba(37,99,235,.1)"
      }},
...
function AgentScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      background: _darkMode?"rgba(37,99,235,.06)":"rgba(37,99,235,.04)",
      marginBottom: 14
    },
...
Do not include the technician's name in the text. Do not add any preamble or sign-off.`, `Generate a closing comment from this job information:\n${context}`);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      flex: 1,
      background: copied ? "rgba(39,174,96,.15)" : "rgba(37,99,235,.12)",
      border: `1px solid ${copied ? "rgba(39,174,96,.4)" : "rgba(37,99,235,.3)"}`,
      borderRadius: 10,
      padding: "12px",
      cursor: "pointer",
      fontSize: 13,
